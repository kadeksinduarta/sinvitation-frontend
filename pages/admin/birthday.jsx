...
export default function AdminBirthday() {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            await apiAdmin.deleteOrder('birthday', id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingId) {
                await apiAdmin.updateOrder('birthday', editingId, formData);
                toast.success('Data birthday berhasil diperbarui!');
            } else {
            ...
            {isAdding && (
                <div className="bg-white p-6 rounded-xl shadow-sm border border-orange-100 mb-6">
                    <h2 className="text-lg font-bold mb-4 text-gray-800">
                        {editingId ? 'Edit Data Birthday' : 'Form Pengisian Data Birthday'}
                    </h2>
