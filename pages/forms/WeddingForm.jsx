...
import { Heart, User, Users, MapPin, Calendar, Music, Image, Upload, CheckCircle, ArrowLeft, Church, PartyPopper, CreditCard } from 'lucide-react';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Object.keys(formData).forEach(key => {
                ...
                } else if (key === 'isi_foto' || key === 'amplop_digital') {
            ...
            await apiClient.submitWeddingOrder(data);
            setSubmitted(true);
    ...
    if (submitted) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 flex items-center justify-center p-4">
                ...
                <div className="text-center bg-white p-10 rounded-3xl shadow-lg border border-pink-100 max-w-md">
                    <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
                        <CheckCircle className="w-10 h-10 text-green-500" />
                    </div>
                    <h1 className="text-2xl font-bold text-gray-900 mb-2">Pesanan Terkirim! 🎉</h1>
                    <p className="text-gray-600 mb-6">Terima kasih, pesanan undangan pernikahan Anda sedang diproses. Tim kami akan segera menghubungi Anda.</p>
                    <button onClick={() => router.push('/')} className="px-8 py-3 bg-pink-600 text-white rounded-xl hover:bg-pink-700 font-bold transition-all">
                        Kembali ke Beranda
                    </button>
                </div>
            </div>
        ...
        <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 py-8 px-4">
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">Form Data Pernikahan</h1>
                    <p className="text-gray-500 mt-2">Lengkapi data berikut untuk pembuatan undangan pernikahan digital Anda</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div className="mt-4">
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-pink-500 outline-none text-sm resize-none"
                            />
                        </div>
                    </div>
                    ...
                    {/* Bukti Transfer */}
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        <SectionTitle icon={Upload} title="Bukti Transfer" color="pink" />
                            ...
                            <label htmlFor="bukti_tranfer" className="cursor-pointer">
                                {preview ? (
                                    <div>
                                        ...
                                        <p className="text-sm text-pink-600 font-medium">Klik untuk ganti foto</p>
                                    </div>
                                ) : (
                                    <div>
                    ...
                    <button
                        type="submit"
                        disabled={submitting}
                        className="w-full py-4 bg-gradient-to-r from-pink-600 to-rose-600 text-white rounded-2xl hover:from-pink-700 hover:to-rose-700 font-bold text-lg shadow-lg shadow-pink-200 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {submitting ? (
