            ...
            <div className="max-w-3xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <InputField label="Nama Yang Ulang Tahun" name="nama_yang_ulang_tahun" value={formData.nama_yang_ulang_tahun} onChange={handleChange} required placeholder="Nama yang berulang tahun" />
                            <InputField label="Ultah Ke-" name="ultah_ke" value={formData.ultah_ke} onChange={handleChange} required placeholder="Contoh: 17" />
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <InputField label="Waktu Acara" name="waktu_acara" value={formData.waktu_acara} onChange={handleChange} required placeholder="18:00 - 21:00 WITA" />
